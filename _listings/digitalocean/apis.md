...
created: "2018-08-27"
modified: "2018-08-27"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/listings/master/_listings/digitalocean/apis.md
...
- name: DigitalOcean API-V2 - Listing Droplets by Tag
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/listings/master/_listings/digitalocean/droplets-get-openapi.md
- name: DigitalOcean API-V2 - Listing Droplets by Tag
  x-api-slug: droplets-get
  description: "To list Droplets by a tag, send a GET request to /v2/droplets?tag_name=$TAG_NAME.\r\n\r\nThe
    response will match that of regular droplet listing request but will be filtered
