...
created: "2018-08-27"
modified: "2018-08-27"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/listings/master/_listings/predix/apis.md
specificationVersion: "0.14"
apis:
- name: Asset - Get a listing of user-defined domain object collections
  x-api-slug: v1-get
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/listings/master/_listings/predix/v1-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/listings/master/_listings/predix/v1-get-openapi.md
- name: Asset - Get a listing of user-defined domain object collections
  x-api-slug: v1-get
  description: Returns the names of all user-defined domain object collections with
    counts of domain objects contained.
